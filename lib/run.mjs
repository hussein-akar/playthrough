...
import { test, check, ambiguous, compile, evaluate, same, truthy } from './expr.mjs';
 ...
 * parses, and every name in it is an input, an enum value, or a field of a list inside a filter
 * (`items.filter(inStock)` starts as the in-stock lines). State fields are not known here:
